...
elseif(EXISTS   ${APPLICATION_SOURCE_DIR}/Kconfig)
  set(KCONFIG_ROOT ${APPLICATION_SOURCE_DIR}/Kconfig)
    ...
    set(KCONFIG_ROOT ${PLATFORM_BASE}/Kconfig)
endif()
...
add_custom_target(
  menuconfig
  srctree=${PLATFORM_BASE}
  KCONFIG_CONFIG=${DOTCONFIG}
  ${PYTHON_EXECUTABLE} ${PLATFORM_BASE}/scripts/kconfig/menuconfig.py ${KCONFIG_ROOT}
...
execute_process(
  COMMAND
  ${PYTHON_EXECUTABLE}
  ${PLATFORM_BASE}/scripts/kconfig/kconfig.py
  ${KCONFIG_ROOT}
  ${DOTCONFIG}
  ${AUTOCONF_H}
  ${merge_fragments}
